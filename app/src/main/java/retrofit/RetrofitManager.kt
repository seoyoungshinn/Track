        ...
        call.enqueue(object : retrofit2.Callback<JsonElement>{
            ...
            override fun onResponse(call: Call<JsonElement>, response: Response<JsonElement>) {
				...
				var facilityType : Int?
                                var facilityTypeString : String?

                                facilityTypeString = properties.get("facilityType")?.asString
                                if(facilityTypeString==""){
                                    facilityType=0
                                }
                                else{
                                    facilityType= facilityTypeString?.toInt()
                                }
                                ...
                                score += SafeRoute.calcPartialScore(totalDistance,distance,roadType,turnType,facilityType)
